...
#fig = sns.pairplot(all_data, hue = "stroke")
# LINE CHARTS
# age vs bmi


# fig4 = plt.figure(figsize=(16, 4))
# sns.scatterplot(x=all_data.age, y=all_data.bmi, data=all_data, hue="stroke")
# fig_1 = sns.catplot(all_data)
# fig_2 = sns.lineplot(data = all_data['age'], label  = "age")
# fig_3 = sns.lineplot(data = all_data['bmi'], label  = 'bmi')
#st.pyplot(age_vs_bmi)
...
marriage = st.radio("Married?", ["Married", "Not Married"])
...
st.info("If you don't know your Glucose value, you can use the average human glucose value of: ___")
...
hypertension = st.radio("Hypertension", ["True", "False"])
...
heart_disease = st.radio("Heart Disease", ["True", "False"])
